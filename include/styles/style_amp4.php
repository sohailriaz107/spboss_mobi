...
<style>
    ...
    .green_bg_color {
        background-image: -webkit-linear-gradient(0deg, #7e8080 20%, #b1bcbe 40%, #506465 100%);
        color: #fff
    }
    ...
    .ss {
        text-shadow: 0 0 3px red, 0 0 5px #968512
    }
    ...
    .panel2 {
        padding: 15px;
        box-shadow: 1px 12px 13px grey;
        margin-bottom: 29px;
        border-radius: 0 7px;
        border-left: 20px solid #696666;
    ...
    .btn-info {
        color: #fff;
        background-color: #897117;
        border-color: #6d736d;
        box-shadow: 2px 3px #88888878
    }
    ...
    .s {
        text-shadow: 2px 0 0 #800040, 3px 2px 0 rgba(77, 0, 38, .5), 3px 0 3px #ff002b, 5px 0 3px #800015, 6px 2px 3px rgba(77, 0, 13, .5), 6px 0 9px #f50, 8px 0 9px #802a00, 9px 2px 9px rgba(77, 25, 0, .5), 9px 0 18px #ffd500, 11px 0 18px #806a00, 12px 2px 18px rgba(77, 66, 0, .5), 12px 0 30px #d4ff00, 14px 0 30px #6a8000, 15px 2px 30px rgba(64, 77, 0, .5), 15px 0 45px #80ff00, 17px 0 45px #408000, 17px 2px 45px rgba(38, 77, 0, .5);
        color: #f0f3ea;
        font-size: 23px
    }
    ...
    .heading-h3 {
        text-shadow: 1px 1px 2px #000, 0 0 25px #fff, 0 0 5px #b3a7a7;
        font-size: 24px;
        color: #fcfcfc;
        font-family: serif;
        text-transform: uppercase
    ...
    * {
    ...
    .login-area a.btn-aa:hover {
        background-image: linear-gradient(-45deg, #9c27b0 50%, #9c27b0 50%);
    ...
    .extra-feature .btn-aa1 {
        background-color: #9c27b0
    }

    .extra-feature .btn-bb1 {
        background-color: #e91e63;
        margin-left: 10px;
        margin-right: 10px
    }

    .extra-feature .btn-cc1 {
        background-color: #9c27b0
    }

    .extra-feature a:hover {
    ...
    .quote-card-div .card-head a:hover {
    ...
    .quote-card-div .card-footer .card-btn:hover {
        color: #000;
        text-shadow: 1px 1px 2px #fff;
    ...
    @media only screen and (max-width:768px) {
        .login-area textarea:focus+.fixed-footer {
            display: none
        }
    }
